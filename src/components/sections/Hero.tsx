    ...
    >
      ...
      <div className="mt-6 relative z-10 flex w-full flex-col items-center px-6 pt-32 pb-5 text-center md:px-8 md:pt-24 md:pb-10">
        ...
        <a
          ...
          data-nav-theme="dark"
          className="group mt-52 flex w-full flex-col items-center gap-2 font-body text-[9px] font-bold uppercase tracking-[0.30em] text-white md:mt-85 md:w-fit md:flex-row md:gap-3 md:text-xs"
        >
