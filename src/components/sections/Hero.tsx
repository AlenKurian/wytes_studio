      ...
      <div className="mt-5 relative z-10 flex w-full flex-col items-center px-6 pt-32 pb-5 text-center md:px-8 md:pt-24 md:pb-10">
        <div ref={contentRef} className="flex max-w-5xl flex-col items-center">
          ...
          <p
            ...
            data-nav-theme="dark"
          >
            We build the strategy, identity, and experiences that shape perception.
          </p>
        ...
        <a
          ...
          data-nav-theme="dark"
          className="group mt-75 flex w-full flex-col items-center gap-2 font-body text-[9px] font-bold uppercase tracking-[0.30em] text-white md:mt-95 md:w-fit md:flex-row md:gap-3 md:text-xs"
        >
