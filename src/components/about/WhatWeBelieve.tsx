      ...
      <div className="mx-auto max-w-5xl px-4 md:px-10">
        ...
        <div className="mt-8 flex flex-col gap-4 md:mt-14 md:gap-8">
          {BELIEFS.map((line, index) => (
            ...
            >
              <p className="text-center font-display text-2xl uppercase leading-tight text-wytes-cream sm:text-5xl md:text-5xl">
                {line.before}{" "}
                <span className="text-lg sm:text-2xl md:text-3xl">Over</span> {line.after}
              </p>
            </RevealOnScroll>
          ))}
        </div>
